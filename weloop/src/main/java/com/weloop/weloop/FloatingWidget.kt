...
private val STATE_KEY = FloatingWidget::class.java.name + ".STATE"
...
class FloatingWidget @JvmOverloads constructor(
    ...
    private val animationProperty = object : Property<FloatingWidget, Float>(Float::class.java, "animation") {

        override fun set(counterFab: FloatingWidget, value: Float) {
            animationFactor = value
            postInvalidateOnAnimation()
        }

        override fun get(counterFab: FloatingWidget): Float {
            return 0f
        }
    }
    ...
    private val textPaint = Paint(Paint.ANTI_ALIAS_FLAG).apply {
        ...
        textSize = this@FloatingWidget.textSize
    ...
    init {
        val styledAttributes = context.theme.obtainStyledAttributes(
            attrs, R.styleable.FloatingWidget, 0, 0
        )
        textPaint.color = styledAttributes.getColor(R.styleable.FloatingWidget_badgeTextColor, Color.WHITE)
        circlePaint.color = styledAttributes.getColor(R.styleable.FloatingWidget_badgeBackgroundColor, getDefaultBadgeColor())
        badgePosition = styledAttributes.getInt(R.styleable.FloatingWidget_badgePosition, RIGHT_TOP_POSITION)
